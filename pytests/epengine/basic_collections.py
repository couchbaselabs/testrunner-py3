...
class basic_collections(BaseTestCase):
    ...
    def test_valid_scope_name(self):
        ...
        for name in valid_scope_name:
            status = self.create_scope(scope=name, bucket=self.default_bucket_name)
            if status is True:
    ...
    def test_valid_collection_name(self):
        ...
        scope_name = "myscope"
        self.create_scope(scope=scope_name, bucket=self.default_bucket_name)
        ...
        for name in valid_collection_name:
            status = self.create_collection(scope=scope_name, collection=name, bucket=self.default_bucket_name)
            if status is True:
    ...
    def test_memecached_basic_api(self):
        ...
        self.create_collection(scope=scope_name, collection=Collection_name, bucket=self.default_bucket_name)
